...
https://github.com/heremaps/here-sdk-examples/blob/master/examples/latest/lite/android/HelloMapLite/
app/src/main/java/com/here/hellomap/PermissionsRequestor.java
*/
...
public class PermissionsRequestor
{
    ...
    public void request(ResultListener resultListener)
    {
        ...
        if (missingPermissions.length == 0) resultListener.permissionsGranted();
        else ActivityCompat.requestPermissions(activity, missingPermissions,
            ...
            if (packageInfo.requestedPermissions != null)
            {
                for (String permission : packageInfo.requestedPermissions)
                {
                            ...
                            activity, permission) != PackageManager.PERMISSION_GRANTED)
                    {
                        ...
                        {
                            // Exclude CHANGE_NETWORK_STATE as it does not require explicit user
                            // approval.
                        ...
                        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q &&
                                (permission.equals(Manifest.permission.ACTIVITY_RECOGNITION) ||
                                        permission.equals(Manifest.permission
                                                .ACCESS_BACKGROUND_LOCATION))) continue;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull int[] grantResults)
    {
        ...
        if (requestCode == PERMISSIONS_REQUEST_CODE)
        {
            ...
            if (allGranted) resultListener.permissionsGranted();
